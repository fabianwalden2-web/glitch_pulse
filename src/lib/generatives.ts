...
void main(void) {
  ...
  "defaultPaletteId": "ember_glow",
  "parameters": [
    { "name": "speed",  "min": 0.0,  "max": 1.2,   "default": 0.4,  "type": "number" },
  ...
  "defaultPaletteId": "acid_matrix",
  "parameters": [
    { "name": "speed",     "min": 0.0, "max": 4.0,  "default": 0.3,  "type": "number" },
    { "name": "size",      "min": 0.3, "max": 3.0,  "default": 1.0,  "type": "number" },
  ...
  "elements": [
    { "id": "background", "name": "Background", "defaultColor": "#ede9e2" },
    ...
    { "id": "axis", "name": "Guides", "defaultColor": "#a4342f" }
  ],
  "uuid": "piano-roll-1"
}*/`,
    code: `// Custom Canvas 2D Implementation rendered natively via UUID interception`
